...
async function connectToDB(){
    ...
    try{
        await mongoose.connect("mongodb+srv://client:pass@cluster1.eqlzj2v.mongodb.net/play_jeopardy?retryWrites=true&w=majority", {useNewUrlParser: true, useUnifiedTopology: true});
...
module.exports = {connectToDB, getCategories, removeDuplicateCategories, removeDuplicateQuestions};
